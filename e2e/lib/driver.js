...
// Verbatim from JustWrite's e2e harness (the family standard) — only
// APP_BIN differs.
...
const APP_BIN  = path.resolve(__dirname, "../../src-tauri/target/release/just_ai_i18n_docgen.exe");
...
export class Driver {
  ...
  async launch() {
    ...
    // Give the app a moment to mount Vue + hydrate stores.
